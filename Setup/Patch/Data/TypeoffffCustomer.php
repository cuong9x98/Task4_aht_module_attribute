...
*/
class TypeoffffCustomer implements DataPatchInterface, PatchRevertableInterface
{
   /**
   ...
   public function addPhoneAttribute()
   {
       ...
       $eavSetup->addAttribute(
           ...
           [
            ...
            //             array (
            //                 0 => 'CBD Manufacturer',
            //                 1 => 'CBD Brand and Marketing company',
            //                 2 => 'CBD Extractor',
            //                 3 => 'Other',
            //             ),
            //     ),
       ...
       $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'company_type');
