...
*/
class OrganizationofffCustomer implements DataPatchInterface, PatchRevertableInterface
{
   /**
   ...
   public function addPhoneAttribute()
   {
       ...
       $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'organization_customer');
